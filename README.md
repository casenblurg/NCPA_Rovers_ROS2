...
The onboard computer communicates to a **Pixhawk CUAV x7** over **USB** interfaced by **Mavros** which will be explained in further detail in the **LT2** section. **Mavros** is a **ROS** package that utilizes the **MavLink** protocol which is the standard messaging protocol usedd by **PX4**.
